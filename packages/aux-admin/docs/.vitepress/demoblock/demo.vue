      ...
      <transition name="arrow-slide">
        ...
        <div>
          ...
          <i :class="[
            ...
            isExpanded ? 'demo-control-icon_up' : 'icon-code',
            'iconfont',
          ]">
          </i>
          <i :class="[
            // 'demo-control-icon',
            // isExpanded ? 'demo-control-icon_up' : 'demo-control-icon_down',
            isExpanded ? 'demo-control-icon_up' : 'icon-typescript',
            'iconfont',
          ]">
          </i>
          <i :class="[
            // 'demo-control-icon',
            // isExpanded ? 'demo-control-icon_up' : 'demo-control-icon_down',
            isExpanded ? 'demo-control-icon_up' : 'icon-vue',
            'iconfont',
          ]">
          </i>
        </div>
...
export default {
  ...
  setup(props, content) {
    ...
    const { codeStr, htmlStr, description } = props;
    let { codePath } = props
    codePath = codePath.split('/docs').pop()
...
<style scoped>
@import url('https://at.alicdn.com/t/c/font_3882013_fwlndr7cje.css?spm=a313x.7781069.1998910419.52&file=font_3882013_fwlndr7cje.css');
